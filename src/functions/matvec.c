...
int matTmat(t_mat a,t_mat b,t_mat *c) {
    t_mat tmp;
    tmp[0][0]=a[0][0]*b[0][0]+a[1][0]*b[1][0]+a[2][0]*b[2][0];
    tmp[0][1]=a[0][0]*b[0][1]+a[1][0]*b[1][1]+a[2][0]*b[2][1];
    tmp[0][2]=a[0][0]*b[0][2]+a[1][0]*b[1][2]+a[2][0]*b[2][2];
    tmp[1][0]=a[0][1]*b[0][0]+a[1][1]*b[1][0]+a[2][1]*b[2][0];
    tmp[1][1]=a[0][1]*b[0][1]+a[1][1]*b[1][1]+a[2][1]*b[2][1];
    tmp[1][2]=a[0][1]*b[0][2]+a[1][1]*b[1][2]+a[2][1]*b[2][2];
    tmp[2][0]=a[0][2]*b[0][0]+a[1][2]*b[1][0]+a[2][2]*b[2][0];
    tmp[2][1]=a[0][2]*b[0][1]+a[1][2]*b[1][1]+a[2][2]*b[2][1];
    tmp[2][2]=a[0][2]*b[0][2]+a[1][2]*b[1][2]+a[2][2]*b[2][2];
    matCpy(tmp,c);
    return 0;
}
